...
// Instancia global del adapter (se reutiliza para mantener sesión)
let adapter: CoordinadoraAdapter | null = null;

function getAdapter(): CoordinadoraAdapter {
  if (!adapter) {
    adapter = new CoordinadoraAdapter({
