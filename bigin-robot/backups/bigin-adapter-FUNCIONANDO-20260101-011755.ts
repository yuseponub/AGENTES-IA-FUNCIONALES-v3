...
export class BiginAdapter {
   ...
   */
  async createOrder(input: CreateOrdenInput): Promise<void> {
    ...
    try {
      ...
      // SKIP CallBell, Transportadora, Guia (left empty as requested)
      console.log('⏭️  Skipping CallBell, Transportadora, Guia (left empty as requested)');
